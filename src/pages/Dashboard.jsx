...
function Dashboard() {
  ...
  return (
    <div className="responsive-container space-y-6 sm:space-y-8">
      {/* Header */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex w-full sm:w-auto flex-col sm:flex-row gap-2 sm:gap-3 mt-4 sm:mt-0">
            <Link to="/knowledge-base" className="btn-secondary w-full sm:w-auto flex items-center justify-center">
              📤 Upload Files
            </Link>
            <Link to="/chat" className="btn-primary w-full sm:w-auto flex items-center justify-center">
              ➕ New Chat
            </Link>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <Link to="/knowledge-base" className="flex items-center p-3 sm:p-4 bg-primary-50 rounded-lg hover:bg-primary-100 transition-colors duration-200 group">
          ...
          <Link to="/chat" className="flex items-center p-3 sm:p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors duration-200 group">
            <span className="text-2xl mr-3 group-hover:scale-110 transition-transform duration-200">💬</span>
            <div>
